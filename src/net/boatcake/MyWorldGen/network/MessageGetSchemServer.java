...
public class MessageGetSchemServer implements MWGMessage {
	...
	public MWGMessage handle(EntityPlayer player) {
		...
		if (playerMP.capabilities.isCreativeMode) {
			...
			response.entitiesTag = Schematic.getEntities(playerMP.worldObj, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2);
			response.tileEntitiesTag = Schematic.getTileEntities(playerMP.worldObj, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2);
			return response;
		}
		return null;
	}
